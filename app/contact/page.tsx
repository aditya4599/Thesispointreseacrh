...
export default function ContactPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <h1 className="font-serif text-4xl text-navy-dark">Contact Us</h1>
      ...
      <div className="mt-12 grid gap-12 lg:grid-cols-2">
        <form
          className="space-y-4 border border-border bg-white p-8 shadow-card"
        ...
        <div className="space-y-6">
          <div className="border border-border bg-surface-light p-6">
            <Mail className="h-6 w-6 text-accent-blue" />
            <h3 className="mt-3 font-semibold text-navy-dark">Email</h3>
            <a
          ...
          <div className="border border-border bg-surface-light p-6">
            ...
            <h3 className="mt-3 font-semibold text-navy-dark">LinkedIn</h3>
            <a
