...
const disclaimer = `
The information contained on this website and in any research reports, articles, pitch decks, or other materials published by Thesis Point Research (collectively, "Materials") is provided for informational and educational purposes only.

**Not Investment Advice.** The Materials do not constitute investment advice, financial advice, trading advice, or any other sort of advice, and you should not treat any of the content as such. Thesis Point Research does not recommend that any security or financial instrument is suitable for any specific person.
...
export default function DisclaimerPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      <h1 className="font-serif text-4xl text-navy-dark">Legal Disclaimer</h1>
