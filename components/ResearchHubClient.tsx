...
export function ResearchHubClient({ items }: { items: ResearchItem[] }) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-8">
        <h1 className="font-serif text-4xl text-navy-dark">Research Library</h1>
          ...
          >
            {filtered.map((item) => (
              <article
                ...
                className="flex flex-col gap-3 border border-border bg-white p-5 shadow-card sm:flex-row sm:items-center"
              >
