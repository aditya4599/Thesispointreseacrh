...
function FilterGroup({
  ...
  return (
    <div className="border-b border-border py-4">
      <button
        type="button"
        className="flex w-full items-center justify-between text-sm font-semibold text-navy-dark"
        ...
        <div className="mb-4 flex flex-wrap gap-2">
          {activeChips.map((chip) => (
            <button
              ...
              className="inline-flex items-center gap-1 border border-border bg-white px-2 py-1 text-xs text-text-primary hover:bg-surface-light"
            >
              {chip.label}
              <X className="h-3 w-3" />
            </button>
