...
export function ContentCard(props: ContentCardProps) {
  ...
  if (props.type === "article") {
    ...
    return (
      <motion.article
        whileHover={{ y: -4 }}
        className={`group flex flex-col border border-border bg-white shadow-card transition-shadow hover:shadow-card-hover ${
          featured ? "border-l-4 border-l-accent-gold" : ""
        }`}
      >
        <div
        ...
        <div className="flex flex-1 flex-col p-5">
          ...
          <h3 className="font-serif text-lg leading-snug text-navy-dark group-hover:text-accent-blue">
          ...
          <div className="mt-2 flex items-center justify-between text-xs text-text-muted">
            ...
            <Link
              ...
              className="flex items-center gap-1 font-medium text-accent-blue"
            >
      ...
      >
        <div className="border-b border-border bg-surface-light p-5">
          <div className="flex items-start justify-between">
            <span className="font-mono text-lg font-bold text-navy-dark">
              {data.ticker}
            </span>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <h3 className="mt-2 font-serif text-lg text-navy-dark">
          {data.company}
        </h3>
        <SectorBadge sector={data.sector} />
        <p className="mt-2 line-clamp-2 flex-1 text-sm text-text-muted">
