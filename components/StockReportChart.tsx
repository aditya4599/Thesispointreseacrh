...
export function StockReportChart() {
  return (
    <div className="h-64 min-h-[256px] w-full min-w-[200px] border border-border bg-white p-4">
      ...
      <ResponsiveContainer width="100%" height="90%">
        <BarChart data={data}>
          ...
          <Tooltip />
          <Bar dataKey="revenue" fill="#1B3A6B" name="Revenue" />
          <Bar dataKey="eps" fill="#D4A017" name="EPS" />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
